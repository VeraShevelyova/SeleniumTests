...
public class HomePage extends Page {
  ...
  public final String jobResultsContentClass = "results_content jResultsContent jResultsActive";
  ...
  public void waitUntilResultsLoad(){
    fluientWaitforElement(filteredJobsResults, 5, 1);
  }
  ...
  public Boolean isEmptyListResultsSentensePresent() {
    Boolean isEmptyResultsSentencePresent = emptySearchResults.getText().equals("Your search matching keyword(s) XXX did not return any job results.");
